...
- **Donaciones:** la extensión es gratuita y su única monetización son donaciones voluntarias mediante enlaces externos (Ko-fi, PayPal). No hay verificación de licencia ni funciones de pago, por lo que la extensión no procesa ni transmite ningún dato de pago.